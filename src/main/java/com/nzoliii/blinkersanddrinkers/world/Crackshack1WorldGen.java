...
public class Crackshack1WorldGen extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, BlockPos position)
    {
        ...
        Template template = templatemanager.getTemplate(minecraftserver, new ResourceLocation(BlinkersandDrinkers.MODID+":crackshack1"));

        if(template == null)
        {
            System.out.println("[BID] [Crackshack1WorldGen.java] NO STRUCTURE TO SPAWN!");
            return false;
        }
