...
public class MWG_Crackshack1WorldGen extends WorldGenerator implements IWorldGenerator
{
    ...
    private void generateOverworld(World world, Random rand, int blockX, int blockZ)
    {
        ...
        {
            System.out.println("if ((int) (Math.random() * 100) == 0) thing said structure should generate.");
